...
| Day | Night |
| --- | --- |
| <img src="https://raw.githubusercontent.com/backpack/android/main/docs/view/TextSpans/screenshots/default.png" alt="TextSpans component" width="375" /> |<img src="https://raw.githubusercontent.com/backpack/android/main/docs/view/TextSpans/screenshots/default_dm.png" alt="TextSpans component - dark mode" width="375" /> |
...
Styles can be changed globally through `bpkTextStyle`. Check [theming](https://github.com/backpack/android/blob/main/docs/view/THEMING.md) for more information.
